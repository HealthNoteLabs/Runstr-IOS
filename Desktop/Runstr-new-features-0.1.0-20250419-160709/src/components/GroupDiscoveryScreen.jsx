...
const GroupDiscoveryScreen = () => {
  ...
  // Join a group - changed to show Coming Soon modal
  const handleJoinGroup = async (group, e) => {
    try {
      // Prevent event propagation to parent
      e.stopPropagation();
      
      // Show the Coming Soon modal instead of joining
      setShowModal(true);
    ...
    <div className="px-4 pt-6 pb-20">
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/70">
          <div className="bg-gray-800 p-6 rounded-lg border border-blue-500 max-w-sm mx-auto">
            <h3 className="text-xl font-bold text-white mb-2">Coming Soon</h3>
            <p className="text-gray-300 mb-4">This feature is not yet available and will be coming in a future update.</p>
            <button 
