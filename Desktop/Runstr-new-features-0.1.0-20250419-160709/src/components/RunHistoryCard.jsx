    ...
    <div style={styles.card}>
      ...
      {expandedRuns.has(run.id) && run.splits && run.splits.length > 0 && (
        <div style={styles.splitsContainer}>
          <SplitsTable 
            splits={distanceUnit === 'km' 
              ? (run.splitsKm || run.splits) // Use splitsKm if available, fallback to splits
              : (run.splitsMi || run.splits) // Use splitsMi if available, fallback to splits
            } 
      ...
      <div style={styles.actionsContainer}>
        ...
        >
          {isPosting ? 'Posting...' : isPosted ? 'Posted to Nostr' : 'Post to Nostr'}
        </button>
